function CalendarApp(date) {
    ...
    this.months = ['Jan', 'Fev', 'Mar', 'Abr', 'Mar', 'Jun', 'Jul', 'Ago', 'Set', 'Out', 'Nov', 'Dez'];
    this.quotes = [];
    this.apts = [
      {
    ...
    this.todayIsSpan.textContent = "Hoje é dia " + date.getDate() + " de " +  this.months[date.getMonth()];  
  }
  ...
  CalendarApp.prototype.openDayWindow = function(date){
    ...
    this.dayEventsEle.textContent = _dayTopbarText + "aulas para a data "  + day.getDate() + " de "  + this.months[day.getMonth()] + " de " + day.getFullYear();
  ...
  CalendarApp.prototype.showEventsCreateElesView = function(events) {
    ...
    events.forEach(function(event){
      ...
      // li.innerHtml
      var html = "<span class='start-time'>" + _start.toLocaleTimeString(navigator.language,{hour: '2-digit', minute:'2-digit'}) + "</span> <small>ás</small> ";
